namespace Service
{
    ...
    public class StudentService
    {
        ...
        {
            if (string.IsNullOrEmpty(enroll.StudentId) || enroll.Schedule.ScheduleId < 0)
            {
                errors.Add("Invalid student id or schedule id");
                throw new ArgumentException();
            }

            this.repository.EnrollSchedule(enroll, ref errors);
        }
        ...
        public void DropEnrolledSchedule(Enrollment enroll, ref List<string> errors)
        {
            ...
            this.repository.DropEnrolledSchedule(enroll, ref errors);
        }
        ...
        public Enrollment ViewGrade(string id1, int id2, ref List<string> errors)
        {
            ...
            return this.repository.ViewGrade(id1, id2, ref errors);
        }
    }
}
