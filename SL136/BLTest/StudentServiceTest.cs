namespace ServiceTest
{
    ...
    public class StudentServiceTest
    {
        ...
        public void CalculateGpaWithEnrollmentTest()
        {
            ...
            enrollments.Add(new Enrollment { Grade = "B", GradeValue = 3.0f, Schedule = new Schedule { ScheduleId = 2 }, StudentId = "testId" });
            enrollments.Add(new Enrollment { Grade = "C+", GradeValue = 2.7f, Schedule = new Schedule { ScheduleId = 3 }, StudentId = "testId" });
        ...
        public void GradeErrorTest()
        {
            ...
            //// Act
            studentService.ViewGrade(null, 0, ref errors);
