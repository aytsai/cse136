namespace IRepository
{
    ...
    public interface IStudentRepository
    {
        ...
        void EnrollSchedule(Enrollment enroll, ref List<string> errors);

        void DropEnrolledSchedule(Enrollment enroll, ref List<string> errors);

        List<Enrollment> GetEnrollments(string studentId, ref List<string> errors);

        Enrollment ViewGrade(string id1, int id2, ref List<string> errors);
    }
}
